...
export function registerAssetRoutes(app: FastifyInstance): void {
  ...
  app.get("/robots.txt", async (_request, reply) => {
    await reply
      ...
      .type("text/plain; charset=utf-8")
      .send("User-agent: *\nAllow: /\nDisallow: /checkout/\nDisallow: /out/\nSitemap: https://newslettercover.lol/sitemap.xml\n");
  });
  ...
  app.get("/sitemap.xml", async (_request, reply) => {
    await reply
      ...
      .send('<?xml version="1.0" encoding="UTF-8"?><urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"><url><loc>https://newslettercover.lol</loc><changefreq>daily</changefreq><priority>1.0</priority></url><url><loc>https://newslettercover.lol/about</loc><changefreq>monthly</changefreq></url><url><loc>https://newslettercover.lol/rules</loc><changefreq>monthly</changefreq></url></urlset>');
  });
  ...
  app.get("/site.webmanifest", async (_request, reply) => {
    await reply
      ...
      .send({ name: "Newsletter Cover", short_name: "The Cover", start_url: "/", display: "standalone", background_color: "#ece7dc", theme_color: "#9d1c14", icons: [{ src: "/icons/brand-mark.png", sizes: "512x512", type: "image/png" }] });
  });
}
